...
{
	delegate void ShowDialogResponseHandler(object source, DialogEventArgs e);
	class DialogController {

		public event ShowDialogResponseHandler showDialogResponse;
		...
		public DialogController(ShowDialogResponseHandler showDialogResponse){
			...
			mainDialoguesList = new DialogManagement().readXml (); //read the xml
		...
		Dialog findDialog(List<Dialog> dialogList, int id)
		{
			...
			Dialog d = dialogList.Find (x => x.id == id);
			if(d == null)
